...
ggsave(filename = "Graphs_png/surv_plot_normalized.png", plot = surv_plot_norm$plot, device = "png", height=10, width=10)
ggsave(filename = "Graphs_png/surv_plot_normalized_small.png", plot = surv_plot_norm$plot, device = "png", height=5, width=5)
