...
To detect statistically significant group of genes Gene Set Enrichment Analysis supplemented with Gene ontology (GO) gene sets. [(List of DE pathways)](/Bulk/Tables/Lcp_DE_genes.tsv)
